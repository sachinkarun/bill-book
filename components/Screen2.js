...
var monthh = -1;
const colors = ["#cc33ff", "#FFD523", "#FF6464", "#E5890A"];
var iterator = 0;
...
export default function Screen2() {
    ...
    function getColor(){
        var clr = colors[iterator];
        if(iterator + 1 === colors.length){
            iterator = 0;
        }
        else{
            iterator = iterator + 1;
                ...
                renderItem={({item}) => (
                    ...
                    <View style={isTrue ? (styles.cardList2) : (styles.cardList1) }>
                        ...
                        <View style={styles.bottom}>
                            ...
                            <View style={{justifyContent:'center',alignItems:'center',width:40, height:40, backgroundColor:getColor(), borderRadius:50, marginRight:15}}>
